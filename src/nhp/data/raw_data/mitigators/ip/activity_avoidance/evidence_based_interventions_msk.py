...
def _arthroscopic_meniscal_tear():
    ...
    procedures = [
        lambda x: x.admission_has(
            primary_procedure, "W82"
        ),  # ty: ignore[call-non-callable]
        lambda x: (
            x.admission_has(
                primary_procedure, "W71[45]"
            )  # ty: ignore[call-non-callable]
...
def _dupuytrens():
    ...
    return (
        nhp_apc.admission_has(
            primary_procedure, "T5(2[1256]|4[13])"
        )  # ty: ignore[call-non-callable]
...
def _fusion_surgery():
    ...
    return (
        nhp_apc.admission_has(
            primary_procedure, "V(3(8[23456]|9[34567])|404)"
        )  # ty: ignore[call-non-callable]
        .admission_has(primary_diagnosis, "M54[34589]")  # ty: ignore[call-non-callable]
        .admission_not(
            secondary_diagnosis, "M4(0[012]|[12]|3[01589]|45)"
        )  # ty: ignore[call-non-callable]
...
def _ganglion_excision():
    ...
    return (
        nhp_apc.admission_has(
            primary_procedure, "T(59[12]|60[12])"
        )  # ty: ignore[call-non-callable]
...
def _knee_athroscopy_for_osteoarhritis():
    ...
    procs = DataFrame.unionByName(
        nhp_apc.admission_has(
            primary_procedure, "W85[12]"
        ),  # ty: ignore[call-non-callable]
        nhp_apc.admission_has(
            primary_procedure, "W802"
        )  # ty: ignore[call-non-callable]
        .admission_has(secondary_procedure, "Y767")  # ty: ignore[call-non-callable]
        .admission_has(secondary_procedure, "Z846"),  # ty: ignore[call-non-callable]
    )
...
def _lumbar_disectomy():
    ...
    procs = DataFrame.unionByName(
        nhp_apc.admission_has(
            primary_procedure, "V(33[1-9]|5(1[189]|83)|603)"
        ),  # ty: ignore[call-non-callable]
        nhp_apc.admission_has(
    ...
    return procs.admission_has(
        primary_diagnosis, "M5(1[01]|4[134])"
    ).filter(  # ty: ignore[call-non-callable]
...
def _lumbar_rf_facet_joint_denervation():
    ...
    return (
        nhp_apc.admission_has(
            primary_procedure, "V48[57]"
        )  # ty: ignore[call-non-callable]
        .admission_has(
            primary_diagnosis, "M5(1[289]|4[59])"
        )  # ty: ignore[call-non-callable]
...
def _trigger_finger_release():
    ...
    return (
        nhp_apc.admission_has(
            primary_procedure, "T(69[1289]|7(0[12]|1[189]|2[389]))"
        )  # ty: ignore[call-non-callable]
        .admission_has(
            primary_diagnosis, "M65(3|[89]4)"
        )  # ty: ignore[call-non-callable]
        .filter((F.col("age") >= 19) & (F.col("age") <= 120))
    )
...
def _vertebral_augmentation():
    ...
    return (
        nhp_apc.admission_has(
            primary_procedure, "V44[45]"
        )  # ty: ignore[call-non-callable]
        .admission_has(
            primary_diagnosis, "M80[01234589]"
        )  # ty: ignore[call-non-callable]
        .filter((F.col("age") >= 19) & (F.col("age") <= 120))
    )
