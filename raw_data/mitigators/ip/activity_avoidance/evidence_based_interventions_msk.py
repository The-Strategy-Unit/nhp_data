...
def _arthroscopic_meniscal_tear():
    ...
    df = nhp_apc.admission_not(any_diagnosis, "S832")
    ...
    procedures = [
        ...
        lambda x: x.admission_has(primary_procedure, "W71[45]")
...
def _arthroscopic_shoulder_compression():
    ...
    """
    # pylint: enable=line-too-long
    df = nhp_apc.admission_has(any_diagnosis, "M754").admission_not(
        any_diagnosis, "M751"
    )
...
def _back_injections():
    ...
    ).admission_has(primary_diagnosis, "M545")
...
def _fusion_surgery():
    ...
    return (
        nhp_apc.admission_has(primary_procedure, "V(3(8[23456]|9[34567])|404)")
...
def _ganglion_excision():
    ...
    return (
        nhp_apc.admission_has(primary_procedure, "T(59[12]|60[12])")
...
def _knee_athroscopy_for_osteoarhritis():
    ...
    procs = DataFrame.unionByName(
        nhp_apc.admission_has(primary_procedure, "W85[12]"),
        nhp_apc.admission_has(primary_procedure, "W802")
        .admission_has(secondary_procedure, "Y767")
        .admission_has(secondary_procedure, "Z846"),
    )
...
def _lumbar_disectomy():
    ...
    procs = DataFrame.unionByName(
        nhp_apc.admission_has(primary_procedure, "V(33[1-9]|5(1[189]|83)|603)"),
        nhp_apc.admission_has(
            primary_procedure, "V(52[12589]|(58|60)[89])"
        ).admission_has(secondary_procedure, "Z993"),
    )
