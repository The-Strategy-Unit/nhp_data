...
The Directory of ambulatory emergency care for adults published by the Institute for innovation and
improvement identified 49 58 emergency conditions that have the potential to be managed as an
emergency day case that could be delivered in an SDEC unit.

We have grouped these conditions into four mitigator cohorts:

- Those that the institute suggest have a low potential to be managed on an ambulatory basis
  (10-30% of cases);
- Those that the institute suggest have a moderate potential to be managed on an ambulatory basis
  (30-60% of cases);
- Those that the institute suggest have a high potential to be managed on an ambulatory basis
  (60-90% of cases);
- Those that the institute suggest have a very high potential to be managed on an ambulatory basis
  (90-100% of cases)

The spells identified by these mitigators exclude any with a LOS of >= 3 days as these spells are
considered less likely to be treatable within a day.
This mitigator allows Trusts to make an assumption about what proportion of the identified spells
they think will, in future, be delivered within an SDEC facility and not as an admitted patient.
The model removes this quantity of spells from the IP data and adds them to the A&E outputs as type
5 (SDEC) attendances enabling clear identification and quantification of future SDEC activity with
the model outputs.

NOTE: these mitigators replace the previous set of AEC efficiency mitigators that adjusted the LOS
of selected spells to 0 LOS but kept them within the IP dataset.
